...
\begin{entrylist}
	...
	\entry
		...
		{https://github.com/caiolagana/MultiClassSentimentAnalysis}
		{This project performs a multi-class sentiment analysis for identifying different types of legal documents in a same PDF. It uses TensorFlow and Keras to build a neural network.}
\end{entrylist}
